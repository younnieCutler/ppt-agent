...
const repetitionCodes = new Set(["REPEATED_LAYOUT_RUN", "REPEATED_COMPOSITION_RUN", "DOMINANT_LAYOUT", "DOMINANT_COMPOSITION", "LAYOUT_REPETITION", "REPEATED_THREE_COLUMN_PATTERN", "REPEATED_COMPOSITION_FAMILY_RUN", "DOMINANT_COMPOSITION_FAMILY", "LOW_COMPOSITION_FAMILY_VARIETY", "UNIFORM_CELL_RHYTHM"]);
